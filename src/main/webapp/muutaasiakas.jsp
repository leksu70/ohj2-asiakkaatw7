...
<title>Asiakastietojen muutos</title>
</head>
	...
	<table>
		...
		<tbody>
			<tr>
				...
				<td><input type="button" id="tallenna" value="Hyväksy" onclick="paivitaAsiakas()"></td>
			</tr>
		</tbody>
	</table>
